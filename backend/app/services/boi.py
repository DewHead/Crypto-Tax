...
class BOIService:
    ...
    async def _load_from_db(self, start_date: date, end_date: date):
    ...
    async def _save_to_db(self, rates: Dict[date, float]):
    ...
    async def prefetch_rates(self, start_date: date, end_date: date):
        """
        ...
        await self._load_from_db(start_date, end_date)
            ...
            try:
                ...
                async with httpx.AsyncClient(timeout=30.0) as client:
                    ...
                    if response.status_code == 200:
                        ...
                        await self._save_to_db(new_rates)
    ...
    async def get_usd_ils_rate(self, target_date: date) -> Optional[float]:
        ...
        await self.prefetch_rates(start_date, end_date)
        ...
        for i in range(1, 15):
            ...
            rate = await self.get_usd_ils_rate(prev_date)
